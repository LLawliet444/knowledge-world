...
export const sapiensWorld: World = {
  ...
  scholarStartByDepth: { what: { x: 60, y: 850 }, how: { x: 60, y: 850 }, why: { x: 60, y: 900 }, system: { x: 60, y: 850 } },
  ...
  nodes: [
    // ── What 1: 认知革命 ──────────────────────────────────────────────
    {
      ...
      positions: { what: { x: 300, y: 400 }, how: { x: 112, y: 723 }, why: { x: 112, y: 827 }, system: { x: 112, y: 630 } },
    ...
    // ── What 2: 农业革命 ──────────────────────────────────────────────
    {
      ...
      positions: { what: { x: 393, y: 657 }, how: { x: 393, y: 660 }, why: { x: 393, y: 769 }, system: { x: 393, y: 654 } },
      neighbors: ["n_money"],
    ...
    // ── What 4: 货币 ───────────────────────────────────────────────────
    {
      ...
      positions: { what: { x: 674, y: 599 }, how: { x: 674, y: 641 }, why: { x: 674, y: 786 }, system: { x: 674, y: 681 } },
    ...
    // ── What 5: 想象的秩序 ────────────────────────────────────────────
    {
      ...
      positions: { what: { x: 954, y: 488 }, how: { x: 954, y: 662 }, why: { x: 954, y: 444 }, system: { x: 954, y: 655 } },
    ...
    // ── What 6: 帝国 ────────────────────────────────────────────────────
    {
      ...
      positions: { what: { x: 1263, y: 409 }, how: { x: 1263, y: 706 }, why: { x: 1263, y: 339 }, system: { x: 1263, y: 679 } },
    ...
    // ── What 7: 科学革命 ───────────────────────────────────────────────
    {
      ...
      positions: { what: { x: 1544, y: 399 }, how: { x: 1544, y: 603 }, why: { x: 1544, y: 224 }, system: { x: 1544, y: 592 } },
    ...
    // ── What 8: 资本与科学联姻 ──────────────────────────────────────────
    {
      ...
      positions: { what: { x: 1811, y: 472 }, how: { x: 1811, y: 480 }, why: { x: 1811, y: 181 }, system: { x: 1811, y: 605 } },
      neighbors: ["n_sci_rev"],
